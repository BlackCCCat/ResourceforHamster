...
2. 建议使用全平台（包含iOS）[万象拼音方案下载更新](https://github.com/rimeinn/rime-wanxiang-update-tools)进行方案管理，iOS端可以使用下面的**万象方案管理**
3. iOS输入法前端：
  - [仓输入法](https://apps.apple.com/us/app/%E4%BB%93%E8%BE%93%E5%85%A5%E6%B3%95/id6446617683)
