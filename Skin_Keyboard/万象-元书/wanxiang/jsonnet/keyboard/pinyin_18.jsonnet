// Expose the 18-key compact pinyin keyboard through a thin entry module backed by a shared compact builder.
local Settings = import '../Custom.libsonnet';
local contextLib = import '../lib/core/context.libsonnet';
local layoutResolver = import '../lib/core/layoutResolver.libsonnet';
local compact18 = import '../lib/specs/compact18.libsonnet';
