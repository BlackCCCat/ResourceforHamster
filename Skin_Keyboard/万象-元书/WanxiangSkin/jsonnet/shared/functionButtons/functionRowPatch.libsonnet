...
local pinyin18Layout = import '../../keyboards/pinyin18/layout.libsonnet';
local pinyin14Layout = import '../../keyboards/pinyin14/layout.libsonnet';

{
  functionRowOrderedKeys:: functionButtonSpecs.resolveOrderedKeys(Settings),
  pinyin18LandscapeRows:: pinyin18Layout.getLandscapePatchRows(),
  pinyin14LandscapeRows:: pinyin14Layout.getLandscapePatchRows(),
