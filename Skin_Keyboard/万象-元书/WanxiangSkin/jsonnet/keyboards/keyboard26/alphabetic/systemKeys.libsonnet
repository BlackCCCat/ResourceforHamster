...
local swipeKeyStyles = import '../../../components/key/swipe.libsonnet';
  ...
  build(theme, orientation, keyboardLayout, settings, createButton, hintStyles):: (
      ...
      );
    {
      ...
      '123Button': createButton(
        ...
        {},
        $ + extraHintStyles + extraSwipeStyles + keyFactory.hintStyle('123'),
        false
      ) + {
        backgroundStyle: 'systemButtonBackgroundStyle',
      ...
      // returnKeyType 通知
      garyReturnKeyTypeNotification: keyFactory.makeNotification([0, 2, 3, 5, 8, 10, 11], 'systemButtonBackgroundStyle', 'enterButtonForegroundStyle0'),
      blueReturnKeyTypeNotification14: keyFactory.makeNotification([1, 4], 'enterButtonBlueBackgroundStyle', 'enterButtonForegroundStyle14'),
      blueReturnKeyTypeNotification6: keyFactory.makeNotification([6], 'enterButtonBlueBackgroundStyle', 'enterButtonForegroundStyle6'),
      blueReturnKeyTypeNotification7: keyFactory.makeNotification([7], 'enterButtonBlueBackgroundStyle', 'enterButtonForegroundStyle7'),
      blueReturnKeyTypeNotification9: keyFactory.makeNotification([9], 'enterButtonBlueBackgroundStyle', 'enterButtonForegroundStyle9'),
    }
  ),
}
