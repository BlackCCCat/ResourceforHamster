...
local ipad_keyboard(theme, orientation, keyboardLayout) =
  ...
  local ipad_overrides =
    ...
    toolbar_ipad.getToolBar(theme) +
    {
      ...
      // 2.3. 添加 iPad 专属的 nextButton (地球键)，这里复用了 alphabetic_base 里的 createButton 函数
      nextButton: alphabetic_base.createButton(
        'next',
      ...
      ipad123Button: alphabetic_base.createButton(
        'ipad123',
