...
local keyboard(theme, orientation) =
  ...
  {
    ['number' + std.toString(num) + 'Button']: createButton(std.toString(num), {}, {}, $, false)
    for num in std.range(2, 9)
  } +
  {
    symbolButton: createButton('symbol', layout['竖屏按键尺寸']['symbolButton'], {}, $, false) +{
    ...
    '123Button': createButton('123', layout['竖屏按键尺寸']['123Button'], {}, $, false) + {
      backgroundStyle: 'systemButtonBackgroundStyle',
    ...
    emojiButton: createButton('emoji', layout['竖屏按键尺寸']['emojiButton'], {}, $, false) + {
      backgroundStyle: 'systemButtonBackgroundStyle',
    ...
    cleanButton: createButton('clean', layout['竖屏按键尺寸']['cleanButton'], {}, $, false) + {
       backgroundStyle: 'systemButtonBackgroundStyle',
       action: { shortcut: '#换行' },
       notification: [
    ...
    backspaceButton: createButton(
      'backspace', layout['竖屏按键尺寸']['backspaceButton'], {}, $, false
    ) + {
      backgroundStyle: 'systemButtonBackgroundStyle',
      action: 'backspace',
    ...
    enterButton: createButton(
      'enter', layout['竖屏按键尺寸']['enterButton'], {}, $, false
    ) + {
      backgroundStyle: [
        {
